let _metadata = createMetadata({
	...
	"Title Screen [Super Mario Bros.: The Lost Levels] - Super Mario All-Stars":
		[1993, "SNES", "Super Mario", "Super Mario All-Stars", "2D Platformer"],
	...
	"DS Shroom Ridge (Wave 1) - MK8DX Booster Course Pass Waves 1-3": [
		...
		"Switch",
		"Mario Kart",
		"MK8DX Booster Course Pass Waves 1-3",
		"Racing",
	],
	...
	"Deep Dark Galaxy/Bigmouth Family - Super Mario Galaxy": [
		2007,
		"Wii",
		"Super Mario",
		"Super Mario Galaxy",
	...
	"Persistant Joy (Have A Nice Talk) - Mario & Luigi: Bowser's Inside Story (DS)":
		[
			2009,
			"DS",
			"Mario & Luigi",
	...
	"Title Theme [Mario Party 2] - Mario Party Superstars": [
		2021,
		"Switch",
		"Mario Party",
	...
	"The Moon (Space Land) - Super Mario Land 2: 6 Golden Coins": [
		1992,
		"Game Boy",
		"Super Mario",
		"Super Mario Land 2: 6 Golden Coins",
	...
	"The Kingdom Called Beanbean (Beanbean Fields) - Mario & Luigi: Superstar Saga (GBA)":
		[2003, "GBA", "Mario & Luigi", "Mario & Luigi: Superstar Saga", "RPG"],
	...
	"Pinna Park Beach - Super Mario Sunshine": [
		2002,
		"GameCube",
		"Super Mario",
		"Super Mario Sunshine",
	...
	"Haunty Halls Galaxy/Boo Moon Galaxy (Super Mario World ~ Ghost House) - Super Mario Galaxy 2":
		[2010, "Wii", "Super Mario", "Super Mario Galaxy 2", "3D Platformer"],
	...
	"Wii DK Summit/DK's Snowboard Cross (Wave 4) - MK8DX Booster Course Pass Waves 4-6":
		[
			2023,
			"Switch",
			"Mario Kart",
			"MK8DX Booster Course Pass Waves 4-6",
			"Racing",
		],
	...
	"DK Rap ~ Composed by Grant Kirkhope and George Andreas - Donkey Kong 64": [
		1999,
		"N64",
		"Donkey Kong (Misc)",
		"Donkey Kong 64",
	...
	"Chain Chomp Roulette - Mario Kart Wii": [
		2008,
		"Wii",
		"Mario Kart",
		"Mario Kart Wii",
	...
	"Tour Amsterdam Drift (Wave 4) - MK8DX Booster Course Pass Waves 4-6": [
		2023,
		"Switch",
		"Mario Kart",
		"MK8DX Booster Course Pass Waves 4-6",
	...
	"Crisis Of The Red And Green (Boss Battle) - Mario & Luigi: Partners In Time":
		[2005, "DS", "Mario & Luigi", "Mario & Luigi: Partners In Time", "RPG"],
	...
	"Flipsville Galaxy - Super Mario Galaxy 2": [
		2010,
		"Wii",
		"Super Mario",
		"Super Mario Galaxy 2",
	...
	"Glittertown/Neon City (Wario World ~ Greenhorn Ruins) - Wario Land: Shake It!":
		[2008, "Wii", "Wario Land", "Wario Land: Shake It!", "2D Platformer"],
	...
	"A Working Mole Is A Happy Mole (Moleville)": [
		1996,
		"SNES",
		"Mario Misc",
		"Super Mario RPG: Legend Of The Seven Stars",
	...
	"Mecha King Bob Omb Blast": [
		2023,
		"Switch",
		"Mario + Rabbids",
		"Mario + Rabbids Sparks Of Hope Post-Launch Compilation",
		"RPG",
	],
	...
	"Snifit Of Whiffit! - Paper Mario: Sticker Star": [
		2012,
		"3DS",
		"Paper Mario",
		"Paper Mario: Sticker Star",
	...
	"Dual Scream Ringtone - Luigi's Mansion: Dark Moon": [
		2013,
		"3DS",
		"Luigi's Mansion",
		"Luigi's Mansion: Dark Moon",
	...
	"UHAHAHAHAHA. Nice of the princess to invite us over for a picnic ey, Luigi? I hope she made lotsa spaghetti! Luigi, look! It's from Bowser. Dear pesky plumbers, the koopalings and I have taken over the Mushroom Kingdom. The princess is now a permanent guest at one of my seven Koopa hotels. I dare you to find her if you can. We gotta find the princess! And YOU gotta help us. If you need instructions on how to get through the hotels, check out the enclosed instruction book. - Hotel Mario":
		[1994, "Philips CD-i", "Hotel Mario", "Hotel Mario", "Spaghetti"],
	...
	"Another Crazy Match (Fast Food Frenzy, Track Star, etc) - Mario Party DS":
		[2007, "DS", "Mario Party", "Mario Party DS", "Minigame Compilation"],
	...
	"Secret Course (Super Mario Bros. Theme) - Super Mario Sunshine": [
		2002,
		"GameCube",
		"Super Mario",
		"Super Mario Sunshine",
	...
	"Pausing By The Poolside (Super Mario World ~ Ground) - Super Mario Odyssey":
		[2017, "Switch", "Super Mario", "Super Mario Odyssey", "3D Platformer"],
	...
	"Mount Must Dash (Super Mario Kart ~ Mario Circuit) - Super Mario 3D World":
		[2013, "Wii U", "Super Mario", "Super Mario 3D World", "3D Platformer"],
	...
	"Name Registration - Vs. Super Mario Bros.": [
		1986,
		"Arcade",
		"Super Mario",
		"Vs. Super Mario Bros.",
	...
	"Faster Than All (Handcar Havoc, Slot Car Derby, etc) - Mario Party (N64)":
		[1998, "N64", "Mario Party", "Mario Party", "Minigame Compilation"],
	...
	"The Blue Skies Yonder (Slot Car Derby, Handcar Havoc, etc) - Mario Party 2":
		[1999, "N64", "Mario Party", "Mario Party 2", "Minigame Compilation"],
	...
	"Friendly Competition (Paint Misbehavin', Suger Rush, etc) - Mario Party 8":
		[2007, "Wii", "Mario Party", "Mario Party 8", "Minigame Compilation"],
	...
	"Space Fantasy (Bubble Breeze Galaxy/Bubble Blast Galaxy)  - Super Mario Galaxy":
		[2007, "Wii", "Super Mario", "Super Mario Galaxy", "3D Platformer"],
	...
	"To A New Adventure! (Title Screen) - Mario & Luigi: Bowser's Inside Story (DS)":
		[
			2009,
			"DS",
			"Mario & Luigi",
	...
	"100 Mario Challenge (Super Mario Bros. 3 ~ Grass Land) - Super Mario Maker":
		[2015, "Wii U", "Super Mario", "Super Mario Maker", "2D Platformer"],
	...
	"Grandpa And The Upbeat Tadpoles (Tadpole Pond) - Super Mario RPG (Switch)":
		[2023, "Switch", "Mario Misc", "Super Mario RPG (Switch)", "RPG"],
	...
	"Wayaway Island (Super Mario Bros. 3 ~ Fortress) - Mario & Luigi: Brothership":
		[2024, "Switch", "Mario & Luigi", "Mario & Luigi: Brothership", "RPG"],
});
	...
	if (!guess.isCorrect) {
		...
		if (guessMeta && heardleMeta) {
			...
			metaEvaluation.innerHTML =
				`<div><div>Year: <span>${heardleMeta.year > guessMeta.year ? `Newer than ${guessMeta.year}.` : heardleMeta.year == guessMeta.year ? `${guessMeta.year} is correct!` : `Older than ${guessMeta.year}.`}</span></div>` +
...
function setCurrentHeardle(l) {
	...
	setTimeout(() => {
		const rows = document.querySelectorAll(
			"body > main > div.w-full.flex.flex-col.flex-grow.relative > div > div > div",
		);
		...
		if (stats != null) {
			...
			paresdStats
				.filter(
					(p) => p.correctAnswer == currentHeardle.correctAnswer,
				)[0]
